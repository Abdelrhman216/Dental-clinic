...
namespace DentalClinic
{
    public partial class Addform : Form
    {
        ...
        {
            if (textBox1.Text == "" || textBox2.Text == "" ||  textBox10.Text == "" || textBox6.Text == "" || textBox4.Text == "" || textBox8.Text == "")
            {
                MessageBox.Show("Please enter all the required fields(ID,Age,tel.,address)");
            }
            ...
            else
            {
                try
                {
                    int result = controllerobj.update_patient(short.Parse(textBox3.Text), textBox4.Text, textBox6.Text, textBox8.Text);
                    if (result == 0)
                    {
