...
namespace DentalClinic
{
    class controller
    {
        ...
        internal int insert_patient(string text1, string text2, short v, string text3, string text4, string text5, string text6)
        {
            throw new NotImplementedException();
        }

        internal int update_patient(short v, string text1, string text2, string text3, string text4)
        {
            throw new NotImplementedException();
        }

        internal int update_patient(short v, string text1, string text2, string text3)
        {
            throw new NotImplementedException();
        }
    }
